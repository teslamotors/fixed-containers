...
// Ported from LLVM 242ccbf6b6d9d090762a87138c854f2d93b6ab60/re.alg/re.alg.replace/test2.pass.cpp
...
{
    {
        ...
        char buf[100] = {0};
        Out r = libcxx_fixed_regex::regex_replace(Out(buf), Bi(std::begin(phone_book)),
