...
// Ported from LLVM 242ccbf6b6d9d090762a87138c854f2d93b6ab60/re.regex/re.regex.assign/assign.il.pass.cpp
...
int main(int, char**)
{
    ...
    r2.assign({'(', 'a', '(', '[', 'b', 'c', ']', ')', ')'}, libcxx_fixed_regex::regex::extended);
