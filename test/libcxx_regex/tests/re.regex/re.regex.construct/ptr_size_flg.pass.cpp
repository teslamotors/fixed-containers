...
// Ported from LLVM 242ccbf6b6d9d090762a87138c854f2d93b6ab60/re.regex/re.regex.construct/ptr_size_flg.pass.cpp
...
test(const CharT* p, std::size_t len, std::regex_constants::syntax_option_type f,
     unsigned mc)
{
    libcxx_fixed_regex::basic_regex<CharT> r(p, len, f);
    assert(r.flags() == f);
