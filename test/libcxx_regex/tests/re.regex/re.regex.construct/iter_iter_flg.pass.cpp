...
// Ported from LLVM 242ccbf6b6d9d090762a87138c854f2d93b6ab60/re.regex/re.regex.construct/iter_iter_flg.pass.cpp
...
{
    libcxx_fixed_regex::basic_regex<typename std::iterator_traits<Iter>::value_type> r(first, last, f);
    assert(r.flags() == f);
