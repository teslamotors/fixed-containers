...
// Ported from LLVM 242ccbf6b6d9d090762a87138c854f2d93b6ab60/re.results/re.results.form/form1.pass.cpp
...
int main(int, char**)
{
    ...
    }
    {
        libcxx_fixed_regex::match_results<const char*> m;
        const char s[] = "abcdefghijk";
        assert(libcxx_fixed_regex::regex_search(s, m, libcxx_fixed_regex::regex("cdefghi")));
