...
// Ported from LLVM 242ccbf6b6d9d090762a87138c854f2d93b6ab60/re.submatch/re.submatch.op/compare.pass.cpp
...
test(const std::basic_string<CharT>& x, const std::basic_string<CharT>& y, bool doCStrTests = true)
{
    ...
    typedef libcxx_fixed_regex::sub_match<typename string::const_iterator> sub_match;
#if TEST_STD_VER > 17
...
constexpr void test() {
  ...
  auto ctor = [](const T& string) {
    libcxx_fixed_regex::sub_match<typename T::const_iterator> sm;
