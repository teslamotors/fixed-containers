...
private:
    ...
    [[nodiscard]] constexpr std::ptrdiff_t keys_offset() const noexcept
    {
        return static_cast<std::ptrdiff_t>(
            align_up(value_storage_size(), keys_raw_view_.get_alignment()));
    }

    [[nodiscard]] constexpr std::ptrdiff_t size_offset() const noexcept
    {
        return keys_offset() + static_cast<std::ptrdiff_t>(
                                   align_up(keys_raw_view_.storage_size(), sizeof(std::size_t)));
    }
};
