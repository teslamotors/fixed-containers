...
namespace optional_storage_trivially_copyable
{
template <class T>
...
namespace optional_storage_non_trivially_copyable
{
template <class T>
union OptionalStorage
{
...
template <class T>
using OptionalStorage =
    std::conditional_t<TriviallyCopyable<T>,
                       optional_storage_trivially_copyable::OptionalStorage<T>,
                       optional_storage_non_trivially_copyable::OptionalStorage<T>>;
