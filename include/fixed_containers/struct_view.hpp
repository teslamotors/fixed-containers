...
inline constexpr std::string_view PRIMITIVE = "PRIMITIVE";
inline constexpr std::string_view PRIMITIVE_ENUM = "ENUM_PRIMITIVE";
inline constexpr std::string_view PRIMITIVE_STRING_VIEW = "STRING_VIEW_PRIMITIVE";
